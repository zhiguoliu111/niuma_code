...
下载 [`niuma.exe`](https://niumacode.oss-cn-beijing.aliyuncs.com/releases/niuma.exe) —— 无需安装。支持 Windows 10/11 版本 1809+。
...
- **下载：** [niuma.exe](https://niumacode.oss-cn-beijing.aliyuncs.com/releases/niuma.exe)
